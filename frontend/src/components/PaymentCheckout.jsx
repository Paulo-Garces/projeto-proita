          ...
          {paymentMethod === 'boleto' && (
            <div>
              ...
              {!boletoGenerated ? (
                ...
                >
                  {loading && <Loader2 size={16} className="animate-spin" />}
                  {loading ? 'Gerando boleto...' : 'Gerar Boleto Registrado'}
                </button>
              ) : (
                <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 space-y-4 animate-in fade-in duration-300">
                  <div className="flex items-center gap-2 text-slate-800 font-bold text-sm">
                    <CheckCircle2 className="text-indigo-600 shrink-0" size={18} />
                  ...
                  <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-2.5 text-xs">
                    ...
                    <div className="flex justify-between items-center text-slate-500">
                      ...
                      <span className="font-bold text-slate-750 font-sans text-sm">R$ {currentPlan.price}</span>
                    </div>
                  </div>
