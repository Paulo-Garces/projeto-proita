...
import { Star, Phone, Share2, CheckCircle, Edit2, Trash2, UserCircle2, Heart } from 'lucide-react';
          ...
          {!showEdit && (
            <div className="mt-4 flex justify-center w-full">
              <button
                ...
                className="group/heart p-2.5 rounded-full border border-slate-100 hover:border-red-100 bg-slate-50/50 hover:bg-red-50/50 transition-all duration-200 active:scale-90 hover:scale-105 shadow-sm"
