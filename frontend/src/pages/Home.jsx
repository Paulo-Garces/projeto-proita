...
export default function Home() {
  ...
  return (
    <div className="h-screen w-full overflow-hidden bg-white relative flex flex-col justify-center items-center">
      ...
      <div className="absolute bottom-0 left-0 w-full z-10 flex flex-col justify-end overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-auto min-w-[200%] md:min-w-full -ml-[50%] md:ml-0 translate-y-2">
